...
const CATEGORIES = [
  ...
  { id: "scripts", col: "scripts", name: "Writing script", kind: "script", match: "or", toggle: true,
    hint: "Recognise the alphabet by its shape. OR = any of them; AND = all must appear (e.g. kana + Chinese = Japan)." },
